...
using UserAdminAPI.Providers;
using UserAdminAPI.Results;
...
namespace UserAdminAPI.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        [Authorize]
        [Route("GetUsers")]
        public IQueryable<AccountUsers> GetUsers()
        {
            return db.Users.Select(x => new AccountUsers
            {
                Id = x.Id,
                Email = x.Email,
        ...
        [Route("Update/{id}")]
        [HttpPut]
        public IHttpActionResult Update(string id, ApplicationUser user)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
            ...
            IdentityUser oldUser = UserManager.FindById(id);
            if (oldUser == null)
            {
                return NotFound();
            }
